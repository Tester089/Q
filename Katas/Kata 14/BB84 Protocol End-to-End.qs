namespace Kata {
    ...
    operation RunBB84Protocol() : Unit {
        ...
        let bitsAlis = RandomArray(100);
        let basesAlis = RandomArray(100);
        use qs = Qubit[10];
        PrepareQubits(qs, basesAlis, bitsAlis);
